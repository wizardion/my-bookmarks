...
//         const checked = (
//           (e.target as HTMLInputElement).checked && this.focusedElement.selected
//         );
//         const predicate = (el?: HTMLElement) => nextSibling
...
//           if (
//             ((bookmark instanceof BookmarkElement) ||
//               (bookmark instanceof BookmarkFolderElement))) {
//             bookmark.setSelection(checked);
//             BookmarksAPIManager.setSelection(Number(bookmark.id), checked);
//           }
...
//     if (!this.timeout && this.focusedElement &&
//       e.shiftKey && (e.code === 'ArrowDown' || e.code === 'ArrowUp')) {
...
//       const id = (
//         Math.max(Math.min(page + step, this.toolbar.form.pagination.pageCount), 1)
//       );
...
//         this.focusedElement.setFocus('checkbox');
//         this.focusedElement.setSelection(!checked);
//         BookmarksAPIManager.setSelection(Number(this.focusedElement.id), !checked);
...
//       item.setSelection();
//       BookmarksAPIManager.setSelection(Number(item.id), true);
//     }
//   }
...
//           (element instanceof BookmarkFolderElement)) {
...
//   private static findNextBookmarkElement(
//     element: IBookmarkElement,
//     checked: boolean
//   ): IBookmarkElement | null {
...
//   private static findPrevBookmarkElement(
//     element: IBookmarkElement,
//     checked: boolean
//   ): IBookmarkElement | null {
